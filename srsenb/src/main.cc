...
void parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("expert.report_json_enable",  bpo::value<bool>(&args->general.report_json_enable)->default_value(true), "Write eNB report to JSON file (default disabled).")
    ("expert.report_json_filename", bpo::value<string>(&args->general.report_json_filename)->default_value("/home/grads/s/sant1/Desktop/enb_report.json"), "Report JSON filename (default /tmp/enb_report.json).")
